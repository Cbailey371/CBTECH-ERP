...
const AssignUserToCompany = ({ 
  ...
  }, [open, preselectedUser, preselectedCompany]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await userCompanyService.assignUserToCompany({
      ...
      setError(error.response?.data?.message || 'Error al asignar usuario a empresa');
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Configura el acceso y permisos del usuario en la empresa
                </p>
              </div>
            </div>
          </div>
